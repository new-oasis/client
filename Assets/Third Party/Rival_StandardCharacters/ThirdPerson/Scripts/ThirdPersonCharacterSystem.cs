...
public partial class ThirdPersonCharacterSystem : SystemBase
{
    ...
    public struct ThirdPersonCharacterJob : IJobEntityBatchWithIndex
    {
        ...
        public void Execute(ArchetypeChunk chunk, int batchIndex, int indexOfFirstEntityInQuery)
        {
            ...
            for (int i = 0; i < chunk.Count; i++)
            {
                ...
                chunkThirdPersonCharacterInputs[i] = processor.ThirdPersonCharacterInputs; // safe to remove if not needed. This would be needed if you changed data in your own character component
            }
        }
    }
    ...
    protected unsafe override void OnUpdate()
    {
        Dependency = new ThirdPersonCharacterJob
        {
            ...
            ThirdPersonCharacterInputsType = GetComponentTypeHandle<ThirdPersonCharacterInputs>(false),
