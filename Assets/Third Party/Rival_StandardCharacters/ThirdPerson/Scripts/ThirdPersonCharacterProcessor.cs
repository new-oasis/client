...
public struct ThirdPersonCharacterProcessor : IKinematicCharacterProcessor
{
    ...
    {
        GroundingUp = -math.normalizesafe(ThirdPersonCharacter.Gravity);
    ...
    public unsafe void HandleCharacterControl()
    {
        ...
        else
        {
            ...
            CharacterControlUtilities.StandardAirMove(ref CharacterBody.RelativeVelocity, airAcceleration, ThirdPersonCharacter.AirMaxSpeed, GroundingUp, DeltaTime, false);
        ...
        if (math.lengthsq(ThirdPersonCharacterInputs.MoveVector) > 0f)
        {
            CharacterControlUtilities.SlerpRotationTowardsDirectionAroundUp(ref Rotation, DeltaTime, math.normalizesafe(ThirdPersonCharacterInputs.MoveVector), GroundingUp, ThirdPersonCharacter.RotationSharpness);
        }

        // Reset jump request
        ThirdPersonCharacterInputs.JumpRequested = false;
    }
}
